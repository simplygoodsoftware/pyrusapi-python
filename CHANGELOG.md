...
## [2.49.2] - 2026-08-28
### Added
- Task comments API: added `integration_id` support for custom channels
...
## [2.48.0] - 2026-03-24
### Added
- Knowledge base API: added 'attachments' property to KnowledgeBaseEntityResponse

## [2.47.0] - 2026-03-11
### Added
- Knowledge base API: get/create/update/delete entities, get structure, get/update permissions

## [2.46.0] - 2026-02-17
## Added
Add MAX Messenger source channel

## [2.45.0] - 2025-09-14
## Added
Exists form field filter

## [2.44.0] - 2025-08-26
## Added
Position to TableRow entity

## [2.43.0] - 2025-08-25
## Added
Inbox task groups in get_inbox method

## [2.42.0] - 2025-05-21
## Added
Catalog item filters in get_catalog method
